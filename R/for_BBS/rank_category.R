...
get_rankabun<-function(siteid){
  for(i in 1:length(siteid)){
    site<-siteid[i]
    i_mat<-readRDS(paste("../../DATA/for_BBS/wrangled_data/",site,"/input_mat_for_tailanal.RDS",sep=""))
    ...
    saveRDS(rankabun,paste("../../Results/for_BBS/",site,"/rankabun.RDS",sep=""))
...
# save the result
saveRDS(res_terres,"../../Results/for_BBS/interaction_freq_for_BBS.RDS")
