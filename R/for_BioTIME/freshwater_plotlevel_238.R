...
resloc<-"../../DATA/for_BioTIME/wrangled_data/Freshwater_plotlevel/238/"
...
for(k in 1:length(newsite)){
  resloc2<-paste("../../DATA/for_BioTIME/wrangled_data/Freshwater_plotlevel/238/",newsite[k],"/",sep="")
...
for(k in 1:length(newsite)){
  ...
  resloc<-paste("../../DATA/for_BioTIME/wrangled_data/Freshwater_plotlevel/238/",newsite[k],"/",sep="")
