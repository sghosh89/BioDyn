...
resloc<-"../../DATA/for_BioTIME/wrangled_data/Terrestrial_plotlevel/529/"
...
for(k in 1:length(newsite)){
  resloc2<-paste("../../DATA/for_BioTIME/wrangled_data/Terrestrial_plotlevel/529/",newsite[k],"/",sep="")
...
for(k in 1:length(newsite)){
  ...
  resloc<-paste("../../DATA/for_BioTIME/wrangled_data/Terrestrial_plotlevel/529/",newsite[k],"/",sep="")
...
saveRDS(newsite,"../../DATA/for_BioTIME/wrangled_data/Terrestrial_plotlevel/529/newsite.RDS")
