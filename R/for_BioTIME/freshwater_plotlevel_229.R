...
df<-df%>%filter(site==229)
# multiple sites 

#----------- create result folder for wrangle ddata -------------------------
resloc<-"../../DATA/for_BioTIME/wrangled_data/Freshwater_plotlevel/229/"
...
for(k in 1:length(newsite)){
  ...
  resloc<-paste("../../DATA/for_BioTIME/wrangled_data/Freshwater_plotlevel/229/",newsite[k],"/",sep="")
...
#--------------------------------------------------------
saveRDS(newsite,"../../DATA/for_BioTIME/wrangled_data/Freshwater_plotlevel/229/newsite.RDS")
...
f<-paste("../../DATA/for_BioTIME/wrangled_data/Freshwater_plotlevel/samplingsite_229_selected.html",sep="")
