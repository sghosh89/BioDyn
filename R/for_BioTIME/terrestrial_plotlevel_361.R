...
if(length(newsite)>1){
  for(k in 1:length(newsite)){
    resloc2<-paste("../../DATA/for_BioTIME/wrangled_data/Terrestrial_plotlevel/361/",newsite[k],"/",sep="")
...
for(k in 1:length(newsite)){
  ...
  if(length(newsite)>1){
    resloc<-paste("../../DATA/for_BioTIME/wrangled_data/Terrestrial_plotlevel/361/",newsite[k],"/",sep="")
  }else{
    resloc<-"../../DATA/for_BioTIME/wrangled_data/Terrestrial_plotlevel/361/"
  }
