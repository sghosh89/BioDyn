...
for(k in 1:length(newsite)){
  resloc2<-paste("../../DATA/for_BioTIME/wrangled_data/Freshwater_plotlevel/253/",newsite[k],"/",sep="")
...
#--------------------------------------------------------
saveRDS(newsite,"../../DATA/for_BioTIME/wrangled_data/Freshwater_plotlevel/253/newsite.RDS")
