...
#--------------------------------------------------------------------------------
pdf("../../Results/gather_res/simple/plot_posterior.pdf",height=16,width=15)
...
pdf("../../Results/gather_res/simple/plot_posterior_pointinterval.pdf",height=5,width=8)
op<-par(mar=c(2,2,2,2))
...
pdf("../../Results/gather_res/simple/plot_taxaeffect.pdf",height=3,width=7)
op<-par(mar=c(2,2,2,2))
g_tx
par(op)
dev.off()
...
pdf("../../Results/gather_res/simple/conditional_effects.pdf",height=12,width=16)
