...
if(!dir.exists("../../Results/gather_res/simple_vr_LdM")){
  dir.create("../../Results/gather_res/simple_vr_LdM")
}

#========================================================================================
sink("../../Results/gather_res/simple_vr_LdM/console_bayesian_model_simple_vr_LdM.txt", append=TRUE, split=TRUE)
#====================================================================================================


#===========================
df<-readRDS("../../Results/gather_res/stability_metric_all.RDS")
mydat<-df[,c("source","STUDY_ID","newsite","REALM","TAXA","ORGANISMS","iCV","iCValt","phi","phi_LdM","phi_skw","nsp","L","U","f_nL","f_nU","f_nneg")]
...
saveRDS(basic_model_w_R,"../../Results/gather_res/simple_vr_LdM/basic_model_w_R.RDS")
...
saveRDS(basic_model_w_R_REALM,"../../Results/gather_res/simple_vr_LdM/basic_model_w_R_REALM.RDS")
...
saveRDS(basic_model_w_R_VR,"../../Results/gather_res/simple_vr_LdM/basic_model_w_R_VR.RDS")
...
saveRDS(basic_model_w_R_VR_REALM,"../../Results/gather_res/simple_vr_LdM/basic_model_w_R_VR_REALM.RDS")
...
saveRDS(basic_model_w_R_A,"../../Results/gather_res/simple_vr_LdM/basic_model_w_R_A.RDS")
...
saveRDS(basic_model_w_R_A_REALM,"../../Results/gather_res/simple_vr_LdM/basic_model_w_R_A_REALM.RDS")
...
saveRDS(basic_model_w_R_A_VR,"../../Results/gather_res/simple_vr_LdM/basic_model_w_R_A_VR.RDS")
...
saveRDS(full_model,"../../Results/gather_res/simple_vr_LdM/fullmodel.RDS")
