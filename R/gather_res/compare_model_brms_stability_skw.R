...
library(tidyverse)
#========================================================================================
sink("./console_brms_univar_model_stability_skw.txt", append=TRUE, split=TRUE)
#====================================================================================================
...
saveRDS(null_model,"../../Results/gather_res/null_model_skw.RDS")
...
saveRDS(full_model,"../../Results/gather_res/full_model_skw.RDS")
...
pdf("../../Results/gather_res/conditional_effects_brms_univar_skw.pdf",height=12,width=16)
