...
sink("../../Results/gather_res/simple_subset_birds_21/model_summary_table.txt", append=TRUE, split=TRUE)

# see summary from basic model without realm
bm<-readRDS("../../Results/gather_res/simple_subset_birds_21/basic_model_w_R.RDS")
...
bm<-readRDS("../../Results/gather_res/simple_subset_birds_21/basic_model_w_R_VR.RDS")
post<-posterior_samples(bm)
...
bm<-readRDS("../../Results/gather_res/simple_subset_birds_21/basic_model_w_R_A.RDS")
post<-posterior_samples(bm)
df<-data.frame(Median=NA*numeric(5),
               LowCI0.95=NA*numeric(5),UpCI0.95=NA*numeric(5),
               LowCI0.75=NA*numeric(5),UpCI0.75=NA*numeric(5))
...
bm<-readRDS("../../Results/gather_res/simple_subset_birds_21/basic_model_w_R_A_VR.RDS")
post<-posterior_samples(bm)
...
bm<-readRDS("../../Results/gather_res/simple_subset_birds_21/basic_model_w_R_REALM.RDS")
post<-posterior_samples(bm)
df<-data.frame(Median=NA*numeric(6),
               LowCI0.95=NA*numeric(6),UpCI0.95=NA*numeric(6),
               LowCI0.75=NA*numeric(6),UpCI0.75=NA*numeric(6))
...
bm<-readRDS("../../Results/gather_res/simple_subset_birds_21/basic_model_w_R_VR_REALM.RDS")
post<-posterior_samples(bm)
...
bm<-readRDS("../../Results/gather_res/simple_subset_birds_21/basic_model_w_R_A_REALM.RDS")
post<-posterior_samples(bm)
...
bm<-readRDS("../../Results/gather_res/simple_subset_birds_21/fullmodel.RDS")
post<-posterior_samples(bm)
...
basic_model_w_R<-readRDS("../../Results/gather_res/simple_subset_birds_21/basic_model_w_R.RDS")
basic_model_w_R_REALM<-readRDS("../../Results/gather_res/simple_subset_birds_21/basic_model_w_R_REALM.RDS")
basic_model_w_R_VR<-readRDS("../../Results/gather_res/simple_subset_birds_21/basic_model_w_R_VR.RDS")
basic_model_w_R_VR_REALM<-readRDS("../../Results/gather_res/simple_subset_birds_21/basic_model_w_R_VR_REALM.RDS")
basic_model_w_R_A<-readRDS("../../Results/gather_res/simple_subset_birds_21/basic_model_w_R_A.RDS")
basic_model_w_R_A_REALM<-readRDS("../../Results/gather_res/simple_subset_birds_21/basic_model_w_R_A_REALM.RDS")
basic_model_w_R_A_VR<-readRDS("../../Results/gather_res/simple_subset_birds_21/basic_model_w_R_A_VR.RDS")
full_model<-readRDS("../../Results/gather_res/simple_subset_birds_21/fullmodel.RDS")
