...
# stability ~ R + VR_LdM
# stability ~ R + A
# stability ~ R + A +  VR_LdM

# Models with REALM
# stability ~ R * REALM
# stability ~ (R +  VR_LdM) * REALM
# stability ~ (R + A) * REALM
# stability ~ (R + A +  VR_LdM) * REALM
...
sink("../../Results/gather_res/simple_subset_birds_21_vr_LdM/model_summary_table.txt", append=TRUE, split=TRUE)

# see summary from basic model without realm
bm<-readRDS("../../Results/gather_res/simple_subset_birds_21_vr_LdM/basic_model_w_R.RDS")
...
bm<-readRDS("../../Results/gather_res/simple_subset_birds_21_vr_LdM/basic_model_w_R_VR.RDS")
post<-posterior_samples(bm)
...
rownames(df)<-c("Intercept","Slope_R","Slope_VR_LdM","sd_Taxa_Intercept","sd_TAXA:UID_Intercept")
df1<-post %>%select(b_Intercept)%>% 
  tidybayes::median_qi(.width = c(.95,0.75))
df$Median[1]<-df1$b_Intercept[1]
df$LowCI0.95[1]<-df1$.lower[1]
...
bm<-readRDS("../../Results/gather_res/simple_subset_birds_21_vr_LdM/basic_model_w_R_A.RDS")
post<-posterior_samples(bm)
df<-data.frame(Median=NA*numeric(5),
               LowCI0.95=NA*numeric(5),UpCI0.95=NA*numeric(5),
               LowCI0.75=NA*numeric(5),UpCI0.75=NA*numeric(5))
...
bm<-readRDS("../../Results/gather_res/simple_subset_birds_21_vr_LdM/basic_model_w_R_A_VR.RDS")
post<-posterior_samples(bm)
...
rownames(df)<-c("Intercept","Slope_R","Slope_A","Slope_VR_LdM","sd_Taxa_Intercept","sd_TAXA:UID_Intercept")
df1<-post %>%select(b_Intercept)%>% 
  tidybayes::median_qi(.width = c(.95,0.75))
df$Median[1]<-df1$b_Intercept[1]
df$LowCI0.95[1]<-df1$.lower[1]
...
bm<-readRDS("../../Results/gather_res/simple_subset_birds_21_vr_LdM/basic_model_w_R_REALM.RDS")
post<-posterior_samples(bm)
df<-data.frame(Median=NA*numeric(6),
               LowCI0.95=NA*numeric(6),UpCI0.95=NA*numeric(6),
               LowCI0.75=NA*numeric(6),UpCI0.75=NA*numeric(6))
...
bm<-readRDS("../../Results/gather_res/simple_subset_birds_21_vr_LdM/basic_model_w_R_VR_REALM.RDS")
post<-posterior_samples(bm)
post<-post%>%select(b_Intercept,b_R,b_VR_LdM,
                    b_REALMTerrestrial,`b_R:REALMTerrestrial`,`b_VR_LdM:REALMTerrestrial`,
...
rownames(df)<-c("Intercept_Freshw","Slope_R_Freshw","Slope_VR_LdM_Freshw",
                "Intercept_Terres","Slope_R_Terres","Slope_VR_LdM_Terres",
                "sd_Taxa_Intercept","sd_TAXA:UID_Intercept")
df1<-post %>%select(b_Intercept)%>% 
  tidybayes::median_qi(.width = c(.95,0.75))
df$Median[1]<-df1$b_Intercept[1]
...
df1<-post %>%mutate(b_VR_LdM_terres=b_VR_LdM+`b_VR_LdM:REALMTerrestrial`)%>% select(b_VR_LdM_terres)%>% 
  tidybayes::median_qi(.width = c(.95,0.75))
df$Median[6]<-df1$b_VR_LdM_terres[1]
df$LowCI0.95[6]<-df1$.lower[1]
df$LowCI0.75[6]<-df1$.lower[2]
df$UpCI0.95[6]<-df1$.upper[1]
df$UpCI0.75[6]<-df1$.upper[2]
...
bm<-readRDS("../../Results/gather_res/simple_subset_birds_21_vr_LdM/basic_model_w_R_A_REALM.RDS")
post<-posterior_samples(bm)
...
bm<-readRDS("../../Results/gather_res/simple_subset_birds_21_vr_LdM/fullmodel.RDS")
post<-posterior_samples(bm)
...
basic_model_w_R<-readRDS("../../Results/gather_res/simple_subset_birds_21_vr_LdM/basic_model_w_R.RDS")
basic_model_w_R_REALM<-readRDS("../../Results/gather_res/simple_subset_birds_21_vr_LdM/basic_model_w_R_REALM.RDS")
basic_model_w_R_VR<-readRDS("../../Results/gather_res/simple_subset_birds_21_vr_LdM/basic_model_w_R_VR.RDS")
basic_model_w_R_VR_REALM<-readRDS("../../Results/gather_res/simple_subset_birds_21_vr_LdM/basic_model_w_R_VR_REALM.RDS")
basic_model_w_R_A<-readRDS("../../Results/gather_res/simple_subset_birds_21_vr_LdM/basic_model_w_R_A.RDS")
basic_model_w_R_A_REALM<-readRDS("../../Results/gather_res/simple_subset_birds_21_vr_LdM/basic_model_w_R_A_REALM.RDS")
basic_model_w_R_A_VR<-readRDS("../../Results/gather_res/simple_subset_birds_21_vr_LdM/basic_model_w_R_A_VR.RDS")
full_model<-readRDS("../../Results/gather_res/simple_subset_birds_21_vr_LdM/fullmodel.RDS")
...
cp
saveRDS(cp,"../../Results/gather_res/simple_subset_birds_21_vr_LdM/cp.RDS")
sink()


cp<-readRDS("../../Results/gather_res/simple_subset_birds_21_vr_LdM/cp.RDS")
row.names(cp)<-cp[,1]
cp<-cp[,3:11]
cp<-format(cp,3)
write.csv(cp,"../../Results/gather_res/simple_subset_birds_21_vr_LdM/cp.csv")
