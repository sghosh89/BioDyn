...
get_rankabun<-function(siteid){
  for(i in 1:length(siteid)){
    site<-siteid[i]
    i_mat<-readRDS(paste("../../DATA/for_swisslake/wrangled_data/input_mat_for_tail_analysis_",site,".RDS",sep=""))
    ...
    saveRDS(rankabun,paste("../../Results/for_swisslake/",site,"/rankabun.RDS",sep=""))
...
#r_freshw<-readRDS("../../Results/for_swisslake/summary_table.RDS")
siteid<-c("L1WA","L2UZ","L3LU","L4LZ","L5SE","L6HA","L7BA","L8GR")
...
# save the result
saveRDS(res_freshw,"../../Results/for_swisslake/interaction_freq_for_phytoplankton.RDS")
