...
get_rankabun<-function(siteid){
  for(i in 1:length(siteid)){
    site<-siteid[i]
    i_mat<-readRDS(paste("../../DATA/for_zoop_2014/wrangled_data/",site,"/inputmat_for_tailanal.RDS",sep=""))
    ...
    saveRDS(rankabun,paste("../../Results/for_zoop_2014/",site,"/rankabun.RDS",sep=""))
...
r_freshw<-readRDS("../../Results/for_zoop_2014/summary_table.RDS")
