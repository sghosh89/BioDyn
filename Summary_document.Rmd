...
\begin{figure}[!ht]
\includegraphics[width=18cm]{./Results/gather_res/data_summary_map_ai-pages-3.pdf}
\caption{Data summary \label{fig_data_summary_map}}
\end{figure} 

\begin{figure}[!ht]
\includegraphics[width=18cm]{./Results/gather_res/data_summary.pdf}
\caption{Data summary \label{fig_data_summary}}
\end{figure} 

\begin{figure}[!ht]
\includegraphics[width=18cm]{./Results/gather_res/ratio_for_eachrealm_withtailasym_ai2.pdf}
...
\begin{figure}[!ht]
\includegraphics[width=18cm]{./Results/for_BioTIME/terrestrial_plotlevel/sketch_method_Corl-Coru_ai.pdf}
\caption{method fig. \label{fig_methods}}
\end{figure}
